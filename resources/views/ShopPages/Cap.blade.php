...
@section('content')
    ...
    <div class="container mt-5">
        <div class="row mb-5">
            <div class="col-5">
                <img src="{{asset('image/ca.JPG')}}" class="img-fluid" style="height: 350px; width:400px">
            </div>
            <div class="col-7">
                <h3>Dress Shirt</h3>
        ...
        <div class="row mt-5">
            <div class="col">
                <img src="{{asset('image/cca.JPG')}}" class="img-fluid img2" style="height: 250px">
                <h6 class="text-dark mt-3 text-center">Yellow-Cap</h6>
                <h6 class="text-center text-danger mt-3 a2">
                    Price: <del>1100</del> <span class="text-dark">550</span>
                </h6>
                <center>
            ...
            <div class="col">
                <img src="{{asset('image/\ccc.webp')}}" class="img-fluid img2" style="height: 250px">
                <h6 class="text-dark mt-3 text-center">Grey-Cap</h6>
                <h6 class="text-center text-danger mt-3 a2">
